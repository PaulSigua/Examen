...
a persistence unit "examen63SiguaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examen63Sigua/pom.xml":
...
artifact ("examen63Sigua.war") is already built. You can build
